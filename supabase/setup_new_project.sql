-- =============================================================================
-- VasaviStores — Full database setup for a fresh Supabase project
-- Run this in the Supabase SQL Editor on a NEW project (one-time setup)
-- After running, add your admin user (Step 5) and configure Auth redirect URLs
-- =============================================================================

-- Migration 1: Roles, contact submissions, user_roles, triggers
...
-- Migration 2: Tighten has_role permissions
...
-- Migration 3: Core tables + seed product (TapReview AI NFC Card)
...
-- Migration 4: Order number generator + function revokes
...
-- Migration 5: Revoke function access from public/anon
...
-- Migration 6: Security invoker + order cancellation policy
...
-- Migration 7: RLS fix for anon/public visitors to read products/reviews
